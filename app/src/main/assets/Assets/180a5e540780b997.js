...
class TextComponent {
    ...
    draw() {
        ...
        // 绘制文本
        if (this.content) {
            GL.fillRect(this.x + this.backX, this.y + this.backY, this.backWidth, this.backHeight, 0x80000000);
            GL.drawImage(this.texture, this.x + this.textOuterX, this.y + this.textOuterY, this.textOuterWidth, this.textOuterHeight);
        }
    }
    /** 计算文本位置 */
...
//# sourceMappingURL=%E6%8E%89%E8%90%BD%E7%89%A9%E5%93%81.180a5e540780b997.js.map