...
export default class TriggerShapeRenderer {
    ...
    // 脚本属性
    enabled;
    triggerShapeColorArray;
    actorColliderColorArray;
    actorAnchorColorArray;
    onStart() {
        // 设置初始状态
        this.enabled = true;
        switch (this.state) {
    ...
    renderTriggerShapes() {
        ...
        if (vi > 0) {
            ...
            matrix.project(gl.flip, Camera.width, Camera.height).translate(-sl, -st).scale(tw, th);
    ...
    renderActorAnchors() {
        ...
        if (vi !== 0) {
            ...
            const st = Camera.scrollTop;
            const program = gl.graphicProgram.use();
            gl.matrix.project(gl.flip, Camera.width, Camera.height).translate(-sl, -st).scale(tw, th);
            gl.bindVertexArray(program.vao.a10);
...
//# sourceMappingURL=%E8%A7%A6%E5%8F%91%E5%99%A8%E5%BD%A2%E7%8A%B6%E6%B8%B2%E6%9F%93%E5%99%A8.905fbd1443c9caf5.js.map