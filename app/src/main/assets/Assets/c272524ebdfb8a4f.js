...
export default class MovementPath {
    ...
    render() {
        ...
        if (vi !== 0) {
            ...
            gl.matrix.project(gl.flip, Camera.width, Camera.height).translate(-Camera.scrollLeft, -Camera.scrollTop);
    ...
    renderTerrainsAndObstacles() {
        ...
        if (viMap[0] + viMap[1] + viMap[2] !== 0) {
            ...
            gl.matrix.project(gl.flip, Camera.width, Camera.height)
...
//# sourceMappingURL=%E7%A7%BB%E5%8A%A8%E8%B7%AF%E5%BE%84.c272524ebdfb8a4f.js.map