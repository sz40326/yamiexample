...
export default class Mobile_OperatingWheel {
     ...
     * @returns boolean
     */
    isPointInRect(point, rect, useScreenCoordinates = true) {
        // 参数标准化
    ...
    handleTouchMove = (e) => {
        ...
        const elem = this.getElem();
        const child = this.getChildElem();
        if (!this.isDragging || !touches || !this.active || !child || !elem)
            return;
        // 获取点击坐标
...
//# sourceMappingURL=%E7%A7%BB%E5%8A%A8%E7%AB%AF-%E6%93%8D%E4%BD%9C%E8%BD%AE%E7%9B%98.d654da15889bfc63.js.map