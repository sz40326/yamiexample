...
class DamageNumber {
    ...
    popup(actor, type, value) {
        ...
        if (x >= Camera.scrollLeft &&
            ...
            Fonts[type] !== null) {
            Scene.binding[KEY].push(FetchFloatingNumber().set(x, y, Fonts[type], value));
        }
    }
}
// 漂浮文本列表类
class FloatingList extends Array {
    ...
    render() {
        ...
        if (vi !== 0) {
            ...
            const matrix = Matrix.instance.project(gl.flip, Camera.width, Camera.height).translate(-sl, -st);
...
//# sourceMappingURL=%E4%BC%A4%E5%AE%B3%E6%95%B0%E5%AD%97.ad08a4def6200207.js.map