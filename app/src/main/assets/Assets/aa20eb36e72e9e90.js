...
export default class DialogueSystem {
    ...
    dialogTarget = null;
    suspendedEvent = null;
    transparentColorArray = new Float64Array(4);
    outlineColorArray;
    offsets = [
        { ox: 0, oy: 0 },
        { ox: -1, oy: 0 },
    ...
    onStart() {
        ...
        Scene.on('keydown', (event) => this.onKeyDown(event));
        Scene.on('mousemove', (event) => this.onMouseMove(event));
    }
    /** 处理挂起的事件 */
    ...
    render() {
        ...
        for (const { ox, oy } of this.offsets) {
            ...
            const projMatrix = gl.matrix.project(gl.flip, Camera.width, Camera.height).translate(ox - Camera.scrollLeft, oy - Camera.scrollTop);
...
//# sourceMappingURL=%E5%AF%B9%E8%AF%9D%E7%B3%BB%E7%BB%9F.aa20eb36e72e9e90.js.map